...
(function() {
    ...
    function r(a, b, c, g) { a.addEventListener(b, c, g || !1 === g ? g : !0) }

    function t(a) { a.stopPropagation();
        a.cancelable && a.preventDefault() }

    function w(a, b, c) { c = "" + c;
    ...
    function R(a, b, c) { "string" === typeof a && ("center" === a ? a = (b - c) / 2 | 0 : "right" === a || "bottom" === a ? a = b - c : (c = parseFloat(a), a = "%" === ("" + c !== a && a.substring(("" + c).length)) ? b / 100 * c | 0 : c)); return a }

    function Q() { var a = document.body;
        ...
        r(window, "resize", function() { L = x.clientWidth;
            M = x.clientHeight;
            S() });
        L = x.clientWidth;
        M = x.clientHeight }
    ...
    function ba(a) {
        ...
        T(a, "se");
        T(a, "sw");
        r(a.g.getElementsByClassName("wb-min")[0], "click", function(b) { t(b);
            a.minimize() });
        r(a.g.getElementsByClassName("wb-max")[0], "click", function(b) { t(b);
            a.focus().maximize() });
        G ? r(a.g.getElementsByClassName("wb-full")[0], "click", function(b) { t(b);
            a.focus().fullscreen() }) : a.addClass("no-full");
        r(a.g.getElementsByClassName("wb-close")[0], "click", function(b) { t(b);
            a.close();
            a = null });
        r(a.g, "click", function() { a.focus() }, !1)
    }

    function U(a) { y.splice(y.indexOf(a), 1);
        S();
        a.removeClass("min");
        a.min = !1;
        a.g.title = "" }

    function S() { for (var a = y.length, b = 0, c, g; b < a; b++) c = y[b], g = Math.min((L - 2 * c.left) / a, 250), c.resize(g + 1 | 0, 35, !0).move(c.left + b * g | 0, M - c.bottom - 35, !0) }
    ...
    function T(a, b) {
        ...
        function g(d) {
            ...
            var l = I - H,
                ...
                E;
            if ("title" === b) { a.x += l;
                a.y += m; var n = E = 1 } else {
                if ("e" === b || "se" === b || "ne" === b) { a.width += l; var p = 1 } else if ("w" === b || "sw" === b || "nw" === b) a.x += l, a.width -= l, n = p = 1;
                if ("s" ===
    ...
    e = O.prototype;
    e.mount = function(a) { this.unmount();
        a.h || (a.h = a.parentNode);
        this.body.textContent = "";
        this.body.appendChild(a); return this };
    e.unmount = function(a) { var b = this.body.firstChild; if (b) { var c = a || b.h;
            c && c.appendChild(b);
            b.h = a } return this };
    e.setTitle = function(a) { a = this.title = a;
        this.g.getElementsByClassName("wb-title")[0].firstChild.nodeValue = a; return this };
    e.setBackground = function(a) { w(this.g, "background", a); return this };
    e.setUrl = function(a) { this.body.innerHTML = '<iframe src="' + a + '"></iframe>'; return this };
    e.focus = function() { F !== this && (w(this.g, "z-index", B++), this.addClass("focus"), F && (F.removeClass("focus"), F.i && F.i()), F = this, this.l && this.l()); return this };
    e.hide = function() { return this.addClass("hide") };
    e.show = function() { return this.removeClass("hide") };
    e.minimize = function(a) { C && V();!a && this.min ? (U(this), this.resize().move()) : !1 === a || this.min || (y.push(this), S(), this.g.title = this.title, this.addClass("min"), this.min = !0);
        this.max && (this.removeClass("max"), this.max = !1); return this };
    e.maximize = function(a) { if ("undefined" === typeof a || a !== this.max) this.min && U(this), (this.max = !this.max) ? this.addClass("max").resize(L - this.left - this.right, M - this.top - this.bottom, !0).move(this.left, this.top, !0) : this.resize().move().removeClass("max"); return this };
    e.fullscreen = function(a) { if ("undefined" === typeof a || a !== C) this.min && (this.resize().move(), U(this)), C && V() || (this.body[G](), C = !0); return this };

    function V() { C = !1; if (document.fullscreen || document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement) return document[K](), !0 }
    e.close = function() { this.min && U(this);
        this.j && this.j();
        this.unmount();
        this.g.parentNode.removeChild(this.g);
        F === this && (F = null) };
    e.move = function(a, b, c) { "undefined" === typeof a ? (a = this.x, b = this.y) : c || (this.x = a ? a = R(a, L - this.left - this.right, this.width) : 0, this.y = b ? b = R(b, M - this.top - this.bottom, this.height) : 0);
        w(this.g, "transform", "translate(" + a + "px," + b + "px)");
        this.o && this.o(a, b); return this };
    e.resize = function(a, b, c) { "undefined" === typeof a ? (a = this.width, b = this.height) : c || (this.width = a ? a = R(a, L - this.left - this.right) : 0, this.height = b ? b = R(b, M - this.top - this.bottom) : 0);
        w(this.g, "width", a + "px");
        w(this.g, "height", b + "px");
        this.m && this.m(a, b); return this };
